...
export const BLOCK_DEFS: BlockDef[] = [
  ...
  { id: 'ctxEnemyRage',       type: 'reporter',  category: 'sensing', label: 'ярость врага',         color: '#5cb1d6' },
  { id: 'ctxMyStamina',       type: 'reporter',  category: 'sensing', label: 'выносливость',         color: '#5cb1d6' },
  { id: 'ctxEnemyStamina',    type: 'reporter',  category: 'sensing', label: 'выносливость врага',   color: '#5cb1d6' },
  ...
  { id: 'ctxMyPosition',      type: 'reporter',  category: 'sensing', label: 'моя позиция',          color: '#5cb1d6' },
  { id: 'ctxEnemyPosition',   type: 'reporter',  category: 'sensing', label: 'позиция врага',        color: '#5cb1d6' },
